...
ggplot(datos_Adelie_Gentoo)+
    ...
    stat_summary(aes(x=species, y=body_mass_g),fun=mean, geom="point", shape=20, size=5, color="#8B4C39", fill="#8B4C39") +
    theme_bw()
```
...
graf_den <- ggplot()+
  geom_function(fun=df, color="#8B0000", args = list( df1= df_1, df2=df_2), xlim=c(0,  6))+
